                ...
                <div id={'header'} style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 4em',background:'#2685C9'}}>
                    <div className={styles.headerItem}>
                        <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M11.4446 31.4826L8.5174 28.5554L12.5054 24.5674L15.4326 27.4946L11.4446 31.4826Z" fill="url(#paint0_linear_313_964)"/>
                            <path d="M10.824 26.2488C11.6661 27.349 12.651 28.3338 13.7512 29.176L15.4326 27.4945L12.5054 24.5673L10.824 26.2488Z" fill="url(#paint1_linear_313_964)"/>
                            <path d="M24.3728 31.2535C33.0033 31.2535 39.9996 24.2572 39.9996 15.6267C39.9996 6.99633 33.0033 0 24.3728 0C15.7424 0 8.74609 6.99633 8.74609 15.6267C8.74609 24.2572 15.7424 31.2535 24.3728 31.2535Z" fill="url(#paint2_linear_313_964)"/>
                            <path d="M24.3731 0C23.8434 0 23.3199 0.0266667 22.8037 0.0781961C30.6971 0.865333 36.861 7.52604 36.861 15.6267C36.861 23.7275 30.6971 30.3881 22.8037 31.1753C23.3199 31.2267 23.8434 31.2535 24.3731 31.2535C33.0036 31.2535 39.9999 24.2571 39.9999 15.6267C39.9999 6.99639 33.0036 0 24.3731 0Z" fill="url(#paint3_linear_313_964)"/>
                            <path d="M24.3733 26.6645C30.469 26.6645 35.4106 21.7229 35.4106 15.6272C35.4106 9.53143 30.469 4.58984 24.3733 4.58984C18.2775 4.58984 13.3359 9.53143 13.3359 15.6272C13.3359 21.7229 18.2775 26.6645 24.3733 26.6645Z" fill="url(#paint4_linear_313_964)"/>
                            <path d="M24.3731 4.58984C23.8403 4.58984 23.3164 4.62843 22.8037 4.70145C28.156 5.46349 32.2716 10.0644 32.2716 15.6273C32.2716 21.1902 28.156 25.791 22.8037 26.5531C23.3164 26.6261 23.8403 26.6647 24.3731 26.6647C30.4689 26.6647 35.4105 21.7231 35.4105 15.6273C35.4105 9.53157 30.4689 4.58984 24.3731 4.58984Z" fill="url(#paint5_linear_313_964)"/>
                            <path d="M1.19679 38.8032C-0.580076 37.0264 -0.346978 34.0819 1.68722 32.6067L9.18063 27.1727C9.66385 26.8223 10.33 26.875 10.752 27.297L12.7029 29.248C13.1249 29.67 13.1777 30.3362 12.8273 30.8193L7.39326 38.3127C5.91812 40.347 2.97365 40.5801 1.19679 38.8032Z" fill="#66D6FD"/>
                            <path d="M12.7026 29.248L10.7517 27.297C10.3297 26.875 9.66349 26.8223 9.18036 27.1727L8.18098 27.8974L9.53157 29.248C9.95361 29.67 10.0063 30.3362 9.65596 30.8193L4.22193 38.3127C3.76326 38.9452 3.16247 39.4033 2.49902 39.6813C4.18844 40.3925 6.23973 39.9032 7.39306 38.3127L12.8271 30.8193C13.1775 30.3361 13.1247 29.67 12.7026 29.248Z" fill="#29B4E5"/>
                            <defs>
                                <linearGradient id="paint0_linear_313_964" x1="7.92155" y1="28.025" x2="15.5197" y2="28.025" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B5ADB6"/>
                                    <stop offset="0.5106" stop-color="#918291"/>
                                    <stop offset="1" stop-color="#554E56"/>
                                </linearGradient>
                                <linearGradient id="paint1_linear_313_964" x1="5.30178" y1="26.8717" x2="14.0572" y2="26.8717" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#B5ADB6"/>
                                    <stop offset="0.5106" stop-color="#918291"/>
                                    <stop offset="1" stop-color="#554E56"/>
                                </linearGradient>
                                <linearGradient id="paint2_linear_313_964" x1="8.74609" y1="15.6267" x2="39.9996" y2="15.6267" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#6DA0FF"/>
                                    <stop offset="1" stop-color="#82E5FF"/>
                                </linearGradient>
                                <linearGradient id="paint3_linear_313_964" x1="22.8037" y1="15.6267" x2="39.9999" y2="15.6267" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="#6DA0FF"/>
                                    <stop offset="1" stop-color="#82E5FF"/>
                                </linearGradient>
                                <linearGradient id="paint4_linear_313_964" x1="14.0421" y1="15.6272" x2="32.9882" y2="15.6272" gradientUnits="userSpaceOnUse">
                                    <stop stop-color="white"/>
                                    <stop offset="1" stop-color="#F9F3F1"/>
                                </linearGradient>
                                <linearGradient id="paint5_linear_313_964" x1="23.8663" y1="15.6272" x2="51.6032" y2="15.6272" gradientUnits="userSpaceOnUse">
                    ...
                    <div className={styles.headerItem} onClick={toggleCollapsed}>
                        ...
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <g clip-path="url(#clip0_313_954)">
                                ...
                                <path d="M4 4V20" stroke="white" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/>
                            </g>
                            <defs>
