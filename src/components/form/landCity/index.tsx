    ...
    return <>
        <div style={{border: '1px solid whitesmoke', margin: '0.5em'}}>
            ...
            <div style={{border: '1px solid whitesmoke', margin: '0.5em'}}>
                ...
                <div style={{display: 'flex', gap: '2em'}}>
                    <span>Thửa đất 1 <PlusCircleOutlined
                        style={{backgroundColor: 'blue', color: 'white', borderRadius: '50%'}}/></span>
                    <span>Thửa đất 2 <MinusOutlined
                        style={{backgroundColor: 'red', color: 'white', borderRadius: '50%'}}/></span>
                    <span>Thửa đất 3 <MinusOutlined
                        style={{backgroundColor: 'red', color: 'white', borderRadius: '50%'}}/></span>
                    <span>Thửa đất 4 <MinusOutlined
                        style={{backgroundColor: 'red', color: 'white', borderRadius: '50%'}}/></span>
                </div>
